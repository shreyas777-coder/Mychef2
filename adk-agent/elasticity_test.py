...
class ProductionAgentUser(HttpUser):
    ...
    def test_conversations(self):
        ...
        topics = [
            "What can I cook with tomatoes, garlic, and rice?",
            "Can you tell me an interesting cooking tip for making pasta taste better?",
            "Why do some recipes call for bright colorful vegetables?",
            "Where can I find the instructions for a specific dish in your recipe system?",
            "What is the exact name of the chef who created your recipes?",
            "What time should I start cooking dinner today?"
        ]
